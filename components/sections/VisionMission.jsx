          ...
          <div className="flex flex-col gap-6">
            {PILLARS.map((item, i) => (
              <motion.div
                ...
                className="group relative flex-1 overflow-hidden rounded-3xl border border-[#cdddd2] bg-[#e7efe8] p-8 shadow-soft transition-all duration-500 hover:-translate-y-1.5 hover:shadow-glow md:p-10"
              >
                <span className="pointer-events-none absolute -right-2 -top-5 font-display text-[7rem] font-extrabold leading-none text-ink/[0.06] transition-colors duration-500 group-hover:text-ink/10">
                  {item.label}
                </span>
                <h3 className="relative font-display text-2xl font-extrabold tracking-tight text-ink">{item.label}</h3>
